...
import com.example.fp.backend.model.HistoryData.AdjClose;
import com.example.fp.backend.model.HistoryData.Quote;
import com.example.fp.backend.model.HistoryData.Result;
...
public class HistoryDataEntityMapper {
  public List<HistoryDataEntity> map(Result result){
    ...
    timestamps.forEach(t ->{
      ...
      entity.setDate(String.valueOf(LocalDate.ofInstant(Instant.ofEpochMilli(t*1000L), ZoneId.systemDefault())));
