...
@Service
public class StockDataServiceTCLImpl implements StockDataServiceTCL {
  ...
  public List<Response> getResponse() {
    ...
    String url = String.format("https://query1.finance.yahoo.com/v7/finance/quote?symbols=0700.HK&crumb=%s", crumb);
